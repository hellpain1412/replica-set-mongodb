...
sudo rm -rf {certs,grafana,keyfile,pbm-config,prometheus,scripts,.env,alertmanager,create-account.txt}
...
# Hostname
MONGO1_HOST=mongo1.ten10.io.vn
MONGO2_HOST=mongo2.ten10.io.vn
MONGO3_HOST=mongo3.ten10.io.vn
...
sudo chown -R 999:999 certs keyfile
